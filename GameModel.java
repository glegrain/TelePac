...
public class GameModel extends Observable
{
    ...
    /**
     * Clear the aPreviousRoom stack
     */
    public void clearHistory()
    {
        while ( !this.aPreviousRoom.isEmpty() ) {
